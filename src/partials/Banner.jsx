    ...
    { bannerOpen && (
      <div className="fixed bottom-0 right-0 w-full md:bottom-8 md:right-12 md:w-auto z-60">
        <div className="bg-slate-800 text-slate-50 text-sm p-3 md:rounded shadow-lg flex justify-between">
          <div className='text-slate-500 inline-flex'><a className="font-medium hover:underline text-slate-50" href="https://github.com/cruip/tailwind-landing-page-template" target="_blank" rel="noreferrer">Hubungi<span className="hidden sm:inline">Kami</span></a> <span className="italic px-1.5">Di Whatsapp</span> <a className="font-medium hover:underline text-emerald-400" href="" target="_blank" rel="noreferrer"></a></div>
